...
param systemNodePoolKubeletDiskType string = 'OS'
...
param userNodePoolKubeletDiskType string = 'OS'
...
module aksCluster 'aksCluster.bicep' = {
  ...
  params: {
    ...
    systemNodePoolKubeletDiskType: systemNodePoolKubeletDiskType
    ...
    userNodePoolKubeletDiskType: userNodePoolKubeletDiskType
